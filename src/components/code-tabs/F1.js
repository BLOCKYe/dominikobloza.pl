...
import preview1 from "./img/f12.png";
import preview2 from "./img/f11.png";
...
function F1() {
  ...
  const [data] = useState({
    ...
    link: "Plan-me",
    date: "July 2021",
    desc: "Latest F1 stats. On the site users can check the latest rankings, statistics from recent races and event schedules.",
    tags: "React, Js, Typescript, Figma, API",
    socials: true,
    website: "https://dominikobloza.usermd.net/",
    github: "https://github.com/BLOCKYe/easy-F1",
  });
